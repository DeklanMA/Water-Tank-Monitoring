...
demo = {
    ...
    initDashboardPageCharts: function () {
        ...
        gradientChartOptionsConfigurationWithTooltipGreen1 = {
            maintainAspectRatio: false,
            legend: {
                display: false,
            },
        ...
        var ctxGreen1 = document
            .getElementById("chartLineGreen1")
            .getContext("2d");

        var gradientStroke1 = ctx.createLinearGradient1(0, 230, 0, 50);
        ...
        var myChart = new Chart(ctxGreen1, {
            type: "line",
            data: data,
            options: gradientChartOptionsConfigurationWithTooltipGreen1,
        });
